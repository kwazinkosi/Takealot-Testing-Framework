 ...
 * It provides common functionality for interacting with web elements and managing page-specific actions.
 */
abstract public class BasePage {
     ...
     * Initializes common utilities and PageFactory.
     * 
    ...
    /**
     * Abstract method to determine the visibility of the page.
    ...
    /**
     * Abstract method to determine the visibility of an alert on the page.
     * Must be implemented in the child class.
     * 
    ...
    /**
     * Retrieves the NavBar component.
     * Initializes the NavBar if it's null.
     * 
    ...
    public void click(WebElement element) {
        ...
        reporter.log("Clicked on element: " + element.toString()); // ReportManager log
    }
